...
<ZoomImage
    image={"/img/blog/common/signoz_logs.webp" } alt="Log Management in SigNoz"caption='Logs management in SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/common/signoz_live_logs.webp" } alt="Live tail logging in SigNoz"caption='Live tail logging in SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/common/signoz_log_query_builder.webp" } alt="Advanced Log Query Builder in SigNoz"caption='Advanced Log Query Builder in SigNoz'
/>
