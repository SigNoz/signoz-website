...
referencePost: [open-source-datadog-alternative, jaeger-vs-prometheus]
keywords:
  - prometheus
  - elasticsearch
  - elk stack
...
<ZoomImage
    image={"/img/blog/2022/06/grafana_prometheus_dashboard.webp" } alt="prometheus dashboards built using Grafana"caption='Prometheus Dashboard built using Grafana (Source: Prometheus website)'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/elasticsearch_stack.webp" } alt="The Elasticsearch stack"caption='The Elasticsearch stack'
/>
