...
referencePost: [open-source-datadog-alternative, community-update-06]
keywords:
...
<ZoomImage
   ...
   caption="Build a custom dashboard for your infrastruture with metrics that matters to you!"
