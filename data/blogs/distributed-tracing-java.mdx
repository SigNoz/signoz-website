...
referencePost: [distributed-tracing-nodejs, distributed-tracing-span]
keywords:
  - distributed tracing
  - java
  - spring boot
...
<ZoomImage
   ...
   image={"/img/blog/2022/03/java_app_architecture_opentelemetry_signoz.webp"}
...
<ZoomImage
   ...
   caption="SigNoz dashboard - It shows services from a sample app that comes bundled with the application"
...
2. **Run service discovery with Eureka Server**<br></br>
    ...
    image={"/img/blog/2022/03/service_discovery_eureka.webp"}
    caption="Eureka server is up and running"
...
<ZoomImage
    alt="SigNoz dashboard"
    image={"/img/blog/2022/03/opentelemetry_java_jar_agent.webp"}
    caption="Placed OpenTelemetry Java Jar agent under a folder named agents"
    />
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/scripts_sh_file.webp"}
    caption="Code in scripts.sh file"
/>

<ZoomImage
    alt="Scripts folder"
    image={"/img/blog/2022/03/scripts_folder.webp"}
    caption="Scritps.sh file under scripts folder"
    />
...
image={"/img/blog/2022/03/eureka_running_all_services.webp"}
caption="Running microservices on different ports using service registry"
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/confirm_table_creation.webp"}
    caption="Checking creation of tables after running microservices"
...
<ZoomImage
   ...
   image={"/img/blog/2022/03/serve_ui_port.png"}
   caption="Running sample app UI"
...
<ZoomImage
   ...
   image={"/img/blog/2022/03/create_new_user_java.webp"}
...
<ZoomImage
   ...
   image={"/img/blog/2022/03/java_microservices_list.webp"}
   caption="Microservices in our Java app being monitored in the SigNoz dashboard"
...
image={"/img/blog/2022/03/java_count_of_requests.webp"}
caption="Use advanced filters to see count of requests by service and HTTP status code"
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/run_aggregates.webp"}
    caption="Run aggregates using the dropdown on your traces data quickly"
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/group_aggregates.webp"}
    caption="Group aggregates across a list of dimensions"
...
image={"/img/blog/2022/03/span_specific_filter.webp"}
caption="Use filters to inspect spans that you want to investigate further"
...
image={"/img/blog/2022/03/java_payment_service_traces.webp"}
caption="Flamegraph and Gantt chart for the selected event showing payment service traces with HTTP semantics"
...
image={"/img/blog/2022/03/db_traces.webp"}
caption="Databases traces which show semantics related to mysql db and query details"
