...
referencePost: [open-source-datadog-alternative, community-update-15]
keywords:
...
<ZoomImage
    image={"/img/blog/2022/07/query_builder.webp" } alt="Query builder to build custom dashboards easily"caption='Our new Query Builder lets you create custom dashboards with a selection of dropdowns and auto-suggestions'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/clickhouse_query.webp" } alt="Write native ClickHouse query to build custom dashboards"caption='You can write native ClickHouse queries to build dashboards'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/search_field_value.webp" } alt="Search for field values under each filter category"caption='Search for field values under each filter category'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/log_management.webp" } alt="Upcoming log Management feature in SigNoz"caption='Log Management will be shipped soon with SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/alerts_builder.webp" } alt="Alerts Builder"caption='Alerts Builder will make it easier for users to configure alerts using a set of dropdowns'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/7k_stars_history.webp" } alt="7K GitHub stars"
/>
...
list={[
      {
         ...
         avatar: 'https://avatars.githubusercontent.com/u/30225487?v=4',
         link: "https://github.com/sf-pchakraborty"
      },
      {
         name: 'Zedongh',
         avatar: 'https://avatars.githubusercontent.com/u/13192735?v=4',
         link: "https://github.com/zedongh"
      },
      {
         name: 'Rw4nn',
         avatar: 'https://avatars.githubusercontent.com/u/86979911?v=4',
         link: "https://github.com/rw4nn"
      },
      {
         name: 'Blake R',
         avatar: 'https://avatars.githubusercontent.com/u/85771645?v=4',
         link: "https://github.com/blakeromano"
      },
   ]} 
/>
