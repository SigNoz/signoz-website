...
<ZoomImage
    image={"/img/blog/2022/06/jaeger_flamegraphs.webp" } alt="Jaeger gantt charts"caption='Jaeger's UI showing  spans for selected traces'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/jaeger_dependency_graph.webp" } alt="Jaeger's dependency graph"caption='Jaeger's dependency graph'
/>
