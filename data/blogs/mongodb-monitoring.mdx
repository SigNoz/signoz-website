...
referencePost: [redis-monitoring-opentelemetry-signoz]
keywords:
  - mongodb
  - mongodb monitoring
...
[MongoDB Monitoring with OpenTelemetry and SigNoz](https://signoz.io/blog/redis-monitoring-opentelemetry-signoz/)