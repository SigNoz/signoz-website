...
referencePost: [open-source-datadog-alternative, community-update-13]
keywords:
...
<ZoomImage
    image={"/img/blog/2022/05/resource_attributes_filtering.webp" } alt="Filter applications based on resource attributes tag"caption='Apply filters based on deployment environment, namespace, etc. to see required applications'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/filtering_dashboards.webp" } alt="Filter dashboards based on title, description, and tags"caption='Apply filters based on title, description, and tags to see required dashboards'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/team_pic.webp" } alt="Team workation"caption='Our team at a coffee plantation in Coorg, India'
/>
