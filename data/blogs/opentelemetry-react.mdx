...
referencePost: [opentelemetry-angular, open-source-datadog-alternative]
keywords:
  - opentelemetry
  - react
  - opentelemetry react
...
<ZoomImage
    image={"/img/blog/2022/05/opentelemetry_react_update_frontend_port.webp" } alt="Setting frontend UI port number"/>
/>
...
<ZoomImage
    image={"/img/blog/2022/05/opentelemetry_react_network_requests.webp" } alt="Network request"caption='Snapshot of network request'
/>

<br></br>

<ZoomImage
    image={"/img/blog/2022/05/opentelemetry_react_frontend_ui.webp" } alt="Network request"caption='React Frontend UI'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/opentelemetry_react_traces_tab.webp" } alt="Analyze your tracing data with powerful filters"caption='Analyze your tracing data with powerful filters'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/opentelemetry_react_flamegraphs.webp" } alt="Monitor spans from your frontend React application"caption=''
/>
