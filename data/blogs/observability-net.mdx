...
<ZoomImage
    image={"/img/blog/2022/09/3-pillars-new.webp" } alt="3 Pillars of observabiltiy"caption='Today observability is generally projected as having 3 siloed pillars. But is this accurate?'
/>
...
<ZoomImage
    image={"/img/blog/2022/08/logs_traces.webp" } alt="Logs in Traces"caption='Events can be added in traces to give more context'
/>
...
<ZoomImage
    image={"/img/blog/2022/08/trace_aggregation.webp" } alt="Trace aggregation"caption='Creating metrics from traces: Trace aggregates showing p90 latency group by `operation name`'
/>
...
<ZoomImage
    image={"/img/blog/2022/09/unknown-questions.webp" } alt="Dashboard or Siri"caption='Dashboards or Siri? Observability systems can be much more powerful than just a bunch of dials.'
/>
