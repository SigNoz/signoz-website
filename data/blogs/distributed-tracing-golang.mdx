...
referencePost: [open-source-datadog-alternative, distributed-tracing]
keywords:
  - distributed tracing
  - golang
  - tracing golang
...
<ZoomImage
    image={"/img/blog/2022/05/distributed_tracing_app_otel_signoz.webp" } alt="How an application with microservices fits with OpenTelemetry and SigNoz"caption='Application architecture along with OpenTelemetry(OTel Collector) and SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/distributed_tracing_golang_sql.webp" } alt="Screenshot of terminal showing MySQL database working"/>
/>
...
1. Create a user:<br></br>
   ...
   <ZoomImage
    image={"/img/blog/2022/05/dt_golang_create_user.webp" } alt="Create user using UI"/>
    />
    <br></br>
...
2. Transfer the fund:<br></br>
   ...
   <ZoomImage
    image={"/img/blog/2022/05/dt_golang_transfer_fund.webp" } alt="Transfer Funds using UI"/>
    />
    <br></br>
...
3. Place an order:<br></br>
   Place an order by selecting a product from the dropdown.
    ...
    <ZoomImage
    image={"/img/blog/2022/05/dt_golang_place_order.webp" } alt="Place orders using UI"/>
    />
    <br></br>
...
<ZoomImage
    image={"/img/blog/2022/05/dt_golang_application_metrics.webp" } alt="SigNoz dashboard showing application metrics"caption='Track important application metrics like latency, requests per second(rps), error percentage, and top endpoints with SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/dt_golang_external_calls.webp" } alt="SigNoz dashboard showing external calls"caption='Monitor external calls from a service that can help you with insights regarding network connectivity'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/dt_golang_gantt.webp" } alt="SigNoz dashboard showing a user request broken down by Flamegraphs and Gantt charts"caption='Flamegraphs and Gantt charts on SigNoz dashboard can be used to see complete breakdown of user requests as it propagates across services'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/dt_golang_gantt_2.webp" } alt="Gantt charts showing details on time utilised in various SQL DB calls"caption='Gantt charts can give you detailed information on things like Db calls'
/>
