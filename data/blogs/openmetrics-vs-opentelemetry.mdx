...
<ZoomImage
    image={"/img/blog/2022/05/opentelemetry_pipeline_light.webp" } alt="OpenTelemetry uses client libraries to instrument application code which is then sent to OpenTelemetry Collectors. The OTel collector then exports it to a backend analysis tool of your choice."caption='OpenTelemetry Architecture - A look behind how OTel interacts with your application'
/>
...
<ZoomImage
    image={"/img/blog/common/signoz_flamegraphs.webp" } alt="How opentelemetry fits with an application"caption='Spans of a trace visualized with the help of flamegraphs and gantt charts in SigNoz dashboard'
/>
