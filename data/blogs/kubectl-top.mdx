...
referencePost: [kubernetes-monitoring, open-source-datadog-alternative]
keywords:
  - kubectl
  - kubernetes
  - kubectl top
...
<ZoomImage
    image={"/img/blog/2022/06/k8s_node_monitoring.webp" } alt="Node metrics monitoring with SigNoz"caption='Kubernetes node metrics monitoring with SigNoz'
/>
