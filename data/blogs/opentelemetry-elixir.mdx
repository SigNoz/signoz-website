...
referencePost: [opentelemetry-angular]
keywords:
  - opentelemetry
  - elixir
...
<ZoomImage
    image={"/img/blog/2022/05/elixir_app_signoz_dashboard.webp" } alt="Elixir app being monitored on SigNoz dashboard"caption='Elixir Phoenix API being monitored on the SigNoz dashboard. The other applications are sample apps that come bundled with SigNoz installation.'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/elixir_application_metrics.webp" } alt="Monitor Elixir application metrics"caption='You can monitor latency, requests per sec, error percentage, and top endpoints of your Elixir application.'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/elixir_traces_tab.webp" } alt="Analyze your trace data with powerful filters"caption='The Traces tab of SigNoz provides you with powerful filters to analyze your tracing data.'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/elixir_flamegraphs.webp" } alt="Flamegraphs and Gantt Charts"caption='You can see the complete breakdown of your requests with details like how much time each operation took, span attributes, etc.'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/elixir_errors_monitoring.webp" } alt="Elixir application error monitoring"caption='Monitor all errors at one place with Exceptions monitoring'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/elixir_stacktrace.webp" } alt="Stacktrace of errors in your Elixir apps in the SigNoz dashboard"caption='See stacktrace of errors to dig deeper into why it happened'
/>
