...
<ZoomImage
    image={"/img/blog/2022/06/otel_php_traces_tab.webp" } alt="SigNoz dashboard"caption='Traces tab of SigNoz dashboard comes with a powerful set of filters to analyze your tracing data'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/otel_php_flamegraphs_gantt_charts.webp" } alt="SigNoz dashboard"caption='Flamegraphs and Gantt charts shows the breakdown of a request. The attributes panel gives you more contextual information on each span.'
/>
