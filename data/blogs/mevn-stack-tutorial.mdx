...
<ZoomImage
    image={"/img/blog/2022/06/mongodb_step_2.webp" } alt="MongoDB new project"caption='MongoDB new project'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/mongodb_step_3.webp" } alt="MongoDB creat project"caption='MongoDB create project'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/mongodb_step_4.webp" } alt="MongoDB create a project"caption='MongoDB create a project'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/mongodb_step_6.webp" } alt="MongoDB creating user"caption='MongoDB creating user'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/mongodb_step_7.webp" } alt="MongoDB creating user"caption='MongoDB whiltelisting IP'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/mongodb_step_8.webp" } alt="MongoDB Connecting User"caption='MongoDB Connecting User'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/mongodb_step_9.webp" } alt="MongoDB generating URL"caption='MongoDB generating URL'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/select_vue_3.webp" } alt="Vue create command"caption='Vue create command'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/hello_world_vue_app.webp" } alt="Hello World Vue App"caption='Hello World Vue App'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/mevn_stack_in_action.gif" } alt="Todo app using MEVN stack"caption='MEVN stack in action'
/>
