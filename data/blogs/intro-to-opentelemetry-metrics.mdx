...
slug: intro-to-opentelemetry-metrics
date: 2022-08-19
tags: [opentelemetry]
authors: [tau]
...
referencePost: [open-source-datadog-alternative, redis-monitoring-opentelemetry-signoz]
keywords:
  - opentelemetry
...
<ZoomImage
    image={"/img/blog/2022/08/meter_api_components.webp" } alt="Components of OpenTelemetry Metrics API"caption='The OpenTelemetry Metrics API consist of three main components - Meter Provider, Meter, and Instruments'
/>
...
<ZoomImage
    image={"/img/blog/common/signoz_charts_application_metrics.webp" } alt="Application metrics charts in SigNoz"caption='SigNoz comes with out-of-box charts and visualization for application metrics'
/>
...
<ZoomImage
    image={"/img/blog/common/signoz_custom_dashboard-min.webp" } alt="Custom dashboards with SigNoz"caption='You can create custom metrics monitoring dashboards with SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/common/signoz_alerts.webp" } alt="Enable free cloud monitoring"caption='Set alerts on important metrics and get notified on your preferred channels'
/>
...
[Redis Monitoring with OpenTelemetry and SigNoz](https://signoz.io/blog/redis-monitoring-opentelemetry-signoz/)