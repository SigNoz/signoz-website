...
referencePost: [open-source-datadog-alternative, community-update-10]
keywords:
...
<ZoomImage
   ...
   image={"/img/blog/2022/02/trace_filters_v2.webp"}
   caption="The all-new Traces tab with an exhaustive set of advanced filters"
...
<ZoomImage
   ...
   image={"/img/blog/2022/02/trace-detail_page.webp"}
   caption="Trace detail tab shows a trace broken down into spans. It’s the most popular and convenient way to visualize a transaction across its entire journey."
...
<ZoomImage
   ...
   image={"/img/blog/2022/02/awesome-oss-alternatives.webp"}
/>
...
<ZoomImage
   ...
   image={"/img/blog/2022/02/open-pull-request.webp"}
/>
...
list={[
      {
         name: 'Yoni Bettan',
         avatar: 'https://avatars.githubusercontent.com/u/29724509?v=4',
         position: 'Software Engineer',
         link: "https://github.com/ybettan"
      },
      {
         name: 'Kartik Verma',
         avatar: 'https://avatars.githubusercontent.com/u/3920286?v=4',
         link: "https://github.com/krtkvrm"
      },
   ]} 
/>
...
[fix: local dev setup](https://github.com/SigNoz/signoz/pull/599) by [Kartik Verma](https://github.com/krtkvrm)<br></br>
...
Distributed tracing is built on causal metadata context propagation. Understand what context propagation is, and how it is fundamental to distributed tracing 👇<br></br>
...
<ZoomImage
   alt="open pull request newsletter featured signoz"
   image={"/img/blog/2022/02/trace_spans.webp"}
   caption="A sample trace demonstrating a request initiated by a frontend web client."
   
/>

Read more on the concept of spans in distributed tracing 👇<br></br>
