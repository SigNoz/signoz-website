...
referencePost: [distributed-tracing-nodejs]
keywords:
  - monitoring
  - graphql
  - monitoring graphql
...
<ZoomImage
   ...
   image={"/img/blog/2022/03/graphql_ui.webp"}
   caption="GraphQL interface to fetch data using queries"
...
<ZoomImage
   ...
   image={"/img/blog/2022/03/graphql_app_signoz_dashboard.webp"}
   caption="GraphQL service being monitored by SigNoz"
...
<ZoomImage
   ...
   image={"/img/blog/2022/03/graphql_top_endpoints.webp"}
   caption="List of top endpoints of GraphQL service shown by SigNoz"
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/traces_tab_graphql_spans.webp"}
    caption="SigNoz captures all events related to the GraphQL service. You can use powerful filters to analyze and debug performance issues quickly."
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/graphql_traces.webp"}
    caption="Flamegraph and Gantt charts showing the flow of a request in detail"
...
4. **Troubleshooting an error**<br></br>
  ...
  ```
   ...
   image={"/img/blog/2022/03/graphql_ui_error_message.webp"}
   caption="Cannot query field"
   ...
   <ZoomImage
    ...
    image={"/img/blog/2022/03/graphql_error_traces.webp"}
    caption="Error traces captured from the GraphQL query in Signoz dashboard"
