...
referencePost: [opentelemetry-grpc-golang, distributed-tracing-nodejs]
keywords:
  - opentelemetry
  - angular
...
<ZoomImage
    image={"/img/blog/2022/04/enabling_cors.webp" } alt="Enabling CORS" 
/>
...
<ZoomImage
    image={"/img/blog/2022/04/angular_frontend_webui.webp" } alt="Angular frontend Web UI"caption='Angular Frontend Web UI'
/>
...
<ZoomImage
    image={"/img/blog/2022/04/angular_app_trace_1.webp" } alt="End-to-end tracing of Angular applications"caption='See end-to-end traces from your Angular application to downstream services'
/>
...
<ZoomImage
    image={"/img/blog/2022/04/angular_app_trace_2.webp" } alt="Monitor errors in your frontend Angular applications"caption='Monitor errors in your frontend Angular application'
/>
