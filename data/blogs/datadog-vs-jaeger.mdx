...
<ZoomImage
    ...
    image={"/img/blog/2021/09/datadog_vs_jaeger_dd_dashbaord-min.webp"}
    caption="DataDog APM tool showing infrastructure, metrics, logs, errors, processes, network and code hotspots under a single dashboard"
...
<ZoomImage
    ...
    image={"/img/blog/2021/09/datadog_vs_jaeger_dd_rca-min.webp"}
    caption="Find code hotspots using DataDog APM tool"
