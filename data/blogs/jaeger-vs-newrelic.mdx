...
referencePost: [jaeger-vs-prometheus, jaeger-vs-signoz, jaeger-vs-zipkin, datadog-vs-jaeger]
keywords:
  - jaeger
  - new relic
  - distributed tracing
...
<ZoomImage
    ...
    caption="Jaeger's UI showing traces for selected services"
...
<ZoomImage
    ...
    image={"/img/blog/2021/09/new_relic_distributed_tracing-min.webp"}
    caption="New Relic's distributed tracing dashboard (Source: New Relic Website)"
...
<ZoomImage
    ...
    caption="Jaeger's distributed tracing UI"
