...
referencePost: [distributed-tracing-span, opentelemetry-collector-complete-guide]
keywords:
  - distributed tracing
  - context propagation
...
<ZoomImage
   ...
   caption="A single transaction is broken down into various components it traverses. The above picture shows a popular way of visualizing a trace via Gantt charts. The width of the bars is proportional to the time a given operation took."
...
<ZoomImage
   ...
   image={"/img/blog/2022/02/context_propagation_in_distributed_systems.webp"}
   caption="Context propagation in a fictional e-commerce web application. Trace context or request identifier is passed along the execution flow."
...
<ZoomImage
   ...
   image={"/img/blog/2022/02/types_of_context_propagation.webp"}
   caption="Types of context propagation: In-process and Inter-process context propagation"
