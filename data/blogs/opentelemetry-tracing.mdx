...
<ZoomImage
    ...
    image={"/img/blog/2021/08/opentelemetry_architecture-min.webp"}
    caption="OpenTelemetry architecture - client libraries instrument application code to send telemetry data to a collector agent which then exports the data to a backend analysis tool."
...
<ZoomImage
    ...
    image={"/img/blog/2021/09/details_span-min.webp"}
    caption="SigNoz is a lightweight APM tool based on OpenTelemetry. it provides out of box visualization for traces and metrics."
