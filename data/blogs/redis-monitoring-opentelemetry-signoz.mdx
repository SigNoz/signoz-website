...
slug: redis-monitoring-opentelemetry-signoz
date: 2022-07-20
...
referencePost: [opentelemetry-collector-complete-guide, open-source-datadog-alternative]
keywords:
  - redis
  - redis monitoring
...
<ZoomImage
    image={"/img/blog/2022/07/opentelemetry_collector_3x.webp" } alt="Architecture of OpenTelemetry Collector"caption='OpenTelemetry Collector (OTel Collector) provides a telemetry processing system that can be configured to import and export data in many common formats.'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/redis_otel_collector.webp" } alt="Opentelemetry Collector scraps metrics from Redis instance which is then visualized in SigNoz"caption='Collecting Redis metrics with OpenTelemetry and visualizing the data with SigNoz.'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/signoz_sign_up_page.webp" } alt="Create an account"caption='If you’re first time user, click on Create an account to create a new account'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/signoz_create_an_account.webp" } alt="Sign up page of SigNoz"caption='Create a user account with the required details'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/redis_signoz_dashboard_homepage.webp" } alt="Homepage"caption='SigNoz APM dashboard - comes with metrics monitoring, distributed tracing, and exceptions monitoring, among other things.'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/create_new_dashboard.webp" } alt="Create new dashboard"caption='Create a new dashboard for Redis monitoring'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/add_panel.webp" } alt="Add a time-series or value-based panel"caption='Create either a Time Series or Value-based panels depending on your use case'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/redis_metrics_query_builder.webp" } alt="Metrics Query Builder"caption='Use the Metrics Query Builder to create custom charts for Redis monitoring'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/redis_dashboard_signoz.webp" } alt="Redis monitoring dashboard in SigNoz"caption='Redis monitoring dashboard in SigNoz'
/>
