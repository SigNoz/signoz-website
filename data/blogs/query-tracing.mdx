...
<ZoomImage
    image={"/img/blog/2022/09/tracing-signoz.webp" } alt="tracing signoz"caption='How a distributed trace of a request looks like'
/>
...
<ZoomImage
    image={"/img/blog/2022/09/np1-calls.png" } alt="tracing signoz n+1"caption='Easy to identify N+1 queries in a distributed trace graph'
/>
...
<ZoomImage
    image={"/img/blog/2022/09/n_plus_1.webp" } alt="N+1 query "caption='N+1 queries are suboptimal and can lead to significant perf impact'
/>
