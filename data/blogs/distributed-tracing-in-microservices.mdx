...
referencePost: [distributed-tracing-java, distributed-tracing-nodejs, distributed-tracing, distributed-tracing-span, context-propagation-in-distributed-tracing]
keywords:
  - distributed tracing
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/ds_microservices_architecture.webp"}
    caption="A fictional microservices-based e-commerce website (Source: microservices.io)"
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/uber_microservice.webp"}
    caption="Service topology map of Uber showing hundreds of microservices (Source: Uber Engineering)"
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/flamegraphs_gantt_charts_dt.webp"}
    caption="Tracing data visualized as Flamegraph and Gantt chart. (Source: SigNoz dashboard)"
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/dt_traces_tab.webp"}
...
<ZoomImage
    ...
    image={"/img/blog/2022/03/dt_trace_details_tab.webp"}
