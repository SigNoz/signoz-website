...
referencePost: [open-source-datadog-alternative, community-update-08]
keywords:
...
<ZoomImage
   ...
   image={"/img/blog/2021/12/alerts_snapshot.webp"}
   caption="Alerts page on SigNoz dashboard"
...
<ZoomImage
   ...
   image={"/img/blog/2021/12/setting_alerts.webp"}
   caption="Setting alerts is easy with expressions."
