...
slug: observability-in-microservices-using-distributed-tracing
date: 2022-03-26
...
referencePost: [distributed-tracing-nodejs, distributed-tracing-nodejs, distributed-tracing-span, context-propagation-in-distributed-tracing]
keywords:
  - distributed tracing
  - observability
  - microservices
  ...
  - signoz
---
plementing Distributed Tracing in a Java application](https://signoz.io/blog/distributed-tracing-java/)
...
<ZoomImage
    ...
    caption="Distributed Tracing breaks down a user request into the components that it touches. The width of the bars is proportional to the time a given operation took."
