...
referencePost: [open-source-datadog-alternative, community-update-12]
keywords:
...
<ZoomImage image={'/img/blog/2022/04/better_y_axis_legend.webp'} />

We have also updated our tooltip to reflect the same units.

<ZoomImage image={'/img/blog/2022/04/units_tooltip.webp'} />
...
<ZoomImage
   ...
   image={"/img/blog/2022/04/webhook_integration.webp"}
   caption="Webhooks are now available for alerts"
...
<ZoomImage
   ...
   image={"/img/blog/2022/04/s3_bucket.webp"}
...
<ZoomImage
   ...
   image={"/img/blog/2022/04/org_management_members.webp"}
   caption="Design of upcoming org settings on SigNoz dashboard. You can invite team members to collaborate with you on SigNoz dashboards."
...
<ZoomImage
   ...
   image={"/img/blog/2022/04/6k_stargazers.webp"}
...
We also crossed 700+ members in our slack community. Join us in our journey of building the next-gen observability tool👇<br></br>
...
list={[
      {
         name: 'Amol Umbark',
         avatar: 'https://avatars.githubusercontent.com/u/10277894?v=4',
         link: "https://github.com/mindhash"
      },
      {
         name: 'Ahsan Barkati Profile',
         avatar: 'https://avatars.githubusercontent.com/u/11457225?v=4',
         link: "https://github.com/ahsanbarkati"
      },
   ]} 
/>
...
Read on to find out how distributed tracing can help achieve observability for your microservices-based application👇 <br></br>
