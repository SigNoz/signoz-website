...
referencePost: [opentelemetry-tracing, monitoring-tools]
keywords:
  - opentelemetry
...
<ZoomImage
    image={"/img/blog/2022/09/opentelemetry_architecture.webp" } alt="OpenTelemetry Architecture"caption='Architecture - How OpenTelemetry fits in an application architecture. OTel collector refers to OpenTelemetry Collector'
/>
...
<ZoomImage
    image={"/img/blog/2022/09/collector_pipeline.webp" } alt="Architecture of OpenTelemetry Collector"caption='Architecture of OpenTelemetry Collector with receivers, processors and exporters.'
/>
...
<ZoomImage
    image={"/img/blog/common/signoz_charts_application_metrics.webp" } alt="SigNoz dashboard showing overview metrics like RPS"caption='SigNoz UI showing application overview metrics like RPS, 50th/90th/99th Percentile latencies, and Error Rate'
/>
