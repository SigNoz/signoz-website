...
referencePost: [open-source-datadog-alternative, community-update-17]
keywords:
...
<ZoomImage
    image={"/img/blog/common/signoz_logs.webp" } alt="Log Management in SigNoz"caption='Logs management is available to all users in the latest release of SigNoz'
/>
...
<ZoomImage
    image={"/img/logs/using_agent.png" } alt="Log Management in SigNoz"caption='Logs collection via File or Stdout Logs'
/>
...
<ZoomImage
    image={"/img/blog/2022/09/devops_startups.webp" } alt="3 Pillars of observabiltiy"caption='SigNoz featured as one of the promising SaaS startups in India(Note: Although, we also enable users to configure alerts, we are a better fit for observability domain in Business category)'
/>
...
list={[
      {
         ...
         avatar: 'https://avatars.githubusercontent.com/u/5800814?v=4',
         link: "https://github.com/pts95"
      },
      {
         name: 'Zedongh',
      ...
      {
         name: 'Natrinicle',
         avatar: 'https://avatars.githubusercontent.com/u/6841452?v=4',
         link: "https://github.com/Natrinicle"
      },
      {
         name: 'Sudhanshu',
         avatar: 'https://avatars.githubusercontent.com/u/10415978?v=4',
         link: "https://github.com/sudhanshud"
      },
      {
         name: 'Yifan Yang',
         avatar: 'https://avatars.githubusercontent.com/u/52592278?v=4',
         link: "https://github.com/EthanGeekFan"
      },
   ]} 
/>
...
<ZoomImage
    image={"/img/blog/2022/07/o11y-net-trans.png" } alt="Observability net"caption='A better model where all signals come together to give insights to users'
/>
