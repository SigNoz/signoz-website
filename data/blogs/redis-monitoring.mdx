...
referencePost: [open-source-datadog-alternative, open-source-datadog-alternative]
keywords:
  - redis
  - redis monitoring
...
<ZoomImage
    image={"/img/blog/2022/07/redis_cli_latency.webp" } alt="Latency using Redis CLI"
/>
...
<ZoomImage
    image={"/img/blog/2022/07/redis_cpu_time.webp" } alt="CPU Time of Redis instance monitored using SigNoz"caption='CPU Time monitored on SigNoz Redis Dashboard.'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/redis_info_stats_keyspace.webp" } alt="Redis Cache Hit Ratio"
/>
...
<ZoomImage
    image={"/img/blog/2022/07/memory_fragmentation_ratio.webp" } alt="Memory fragmentation ratio monitored using SigNoz"caption='Memory fragmentation ratio monitored using SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/redis_keys_evicted.webp" } alt="Redis Keys evicted"caption='Evicted keys monitored using SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/2022/07/redis_info_keyspace.webp" } alt="Redis INFO keyspace"
/>
...
[Redis Monitoring with OpenTelemetry and SigNoz](https://signoz.io/blog/open-source-datadog-alternative/)