...
referencePost: [open-source-datadog-alternative, community-update-09]
keywords:
...
<ZoomImage
   ...
   image={"/img/blog/2021/12/graphs_legends.webp"}
   caption="Application latency charts on SigNoz metrics tab"
/>
...
<ZoomImage
   ...
   image={"/img/blog/2021/12/trace_filters_v2_search.webp"}
   caption="Sneak peek of our redesigned Traces tab"
...
<ZoomImage
   ...
   image={"/img/blog/2021/12/user_love.webp"}
/>

One of our [users](https://www.linkedin.com/posts/pawan-bhadauria-25980b7_seed-to-scale-podcast-series-by-accel-insights-activity-6877448856892768256-Fapw) also became a contributor. This is the true essence of open-source, especially for a developer tool. Devs don’t need to wait for anyone to make small tweaks to suit their use-case.
...
PRs by new contributors in the last month:<br></br>

[Allow empty input values in settings retention page](https://github.com/SigNoz/signoz/pull/459) and three others by [Aryan Shridhar](https://github.com/aryanshridhar)<br></br>

[fix: product feedback button](https://github.com/SigNoz/signoz/pull/458) by [Anurag Gupta](https://github.com/Anurag5086)<br></br>

[build(kubernetes): Support hcloud CSI (Hetzner)](https://github.com/SigNoz/signoz/pull/537) by [Hendy Irawan](https://github.com/ceefour)<br></br>

Also, our contributors are loving the swag we ship them. 🥳



   <a href="https://twitter.com/anurag_gupta23/status/1476089058384252929" src="/img/blog/2021/12/contributor_swag_love.webp"  alt="twitter shoutout by contributor" height = "400" width = "280"> . </a>
...
You can monitor your Nestjs application using SigNoz as OpenTelemetry supports nestjs instrumentation. The biggest advantage of using OpenTelemetry is that you don’t get locked into any vendors. It is an open-source project backed by a huge community of developers, cloud and APM vendors. SigNoz is built natively on OpenTelemetry.<br></br>

[Monitor your Nestjs application using OpenTelemetry](https://signoz.io/blog/opentelemetry-nestjs/)<br></br>
