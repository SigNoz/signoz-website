...
<figure data-zoomable>
    image={"/img/blog/common/signoz_charts_application_metrics.webp"} alt="SigNoz dashboard showing popular RED metrics"
...
<ZoomImage
    image={"/img/blog/2022/04/metrics_to_traces.webp"} alt="Seamless flow between metrics and traces"
    caption="Move from metrics to traces at any point of time which needs more analysis"
/>
...
<ZoomImage
    image={"/img/blog/2022/04/powerful_filters_on_traces_data.webp"} alt="Filters on trace data"
    caption="Use advanced filters to analyze your trace data"
/>
...
<ZoomImage
    image={"/img/blog/2022/04/custom_aggregates_filtered_data.webp"} alt="Custom aggregates on filtered traces"
    caption="Find custom aggregates on filtered traces"
/>
...
<ZoomImage
    image={"/img/blog/common/signoz_flamegraphs.webp"} alt="Detailed Flamegraphs & Gantt charts"
...
<ZoomImage
    image={"/img/blog/common/signoz_logs.webp"} alt="Logs tab in SigNoz"
    caption="Logs tab in SigNoz comes equipped with advanced logs query builder and live tailing"
/>
...
<ZoomImage
    image={"/img/blog/2022/04/transparent_usage_data.webp"} alt="Transparent usage data"
    caption="SigNoz provides usage explorer so that you are always informed about your usage"
/>
...
Our slack community is a great place to get your queries solved instantly and get community support for SigNoz. Link to join 👇<br/>
...
**[Not 3 pillars but a single whole to help customers solve issues faster](https://signoz.io/blog/observability-net/)**<br/>
**[An Open Source OpenTelemetry APM](https://signoz.io/blog/opentelemetry-apm/)**<br/>
