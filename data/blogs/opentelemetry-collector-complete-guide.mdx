...
image: /blogs/2022/09/opentelemetry_collector_guide_cover.webp
...
<ZoomImage
  image={"/blogs/2022/09/opentelemetry_architecture.webp"}
...
<ZoomImage
  image={"/blogs/2022/09/collector_pipeline.webp"}
...
[![Deployment Docs](/blogs/common/deploy_docker_documentation.webp)](https://signoz.io/docs/install/docker/?utm_source=blog&utm_medium=opentelemetry_colllector)

SigNoz can be used to visualize metrics and traces with charts that can enable quick insights for your teams.

<ZoomImage
  image={"/blogs/common/signoz_charts_application_metrics.webp"}
...
[![SigNoz repo](/blogs/common/signoz_github.webp)](https://github.com/signoz/signoz)
