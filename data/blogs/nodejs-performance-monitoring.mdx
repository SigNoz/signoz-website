...
date: 2022-06-16
tags: [opentelemetry-instrumentation, javascript, hero-section]
...
referencePost: [opentelemetry-angular, opentelemetry-mongodb]
keywords:
  - nodejs
...
<ZoomImage
    image={"/img/blog/2022/06/enable_cors.webp" } alt="Enabling CORS"caption='Enabling CORS'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/mevn_signoz_dashboard.webp" } alt="MEVN Example Application on Signoz"caption='MEVN Example Application on Signoz'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/nodejs_perf_frontend.webp" } alt="Frontned monitoring on SigNoz"caption='Function calls from frontend being monitored on SigNoz'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/nodejs_perf_app_metrics.webp" } alt="Application metrics on SigNoz"caption='Monitor application metrics like latency, requests per second, error percentage, etc. with out-of-box charts'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/nodejs_perf_traces.webp" } alt="Traces tab on SigNoz"caption='Traces of the /GET endpoint for one of the requests'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/nodejs_perf_flamegraphs.webp" } alt="Flamegraphs and Gantt Charts on SigNoz"caption='Flamegraphs and Gantt charts on SigNoz dashboard help you visualize the complete journey of a user request'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/nodejs_perf_mongodb.webp" } alt="Trace database calls on SigNoz"caption='Trace Mongodb database calls with SigNoz'
/>
