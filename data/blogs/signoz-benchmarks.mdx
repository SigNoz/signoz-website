...
<ZoomImage
  ...
  image={"/img/blog/2021/02/datadog-cost-90rps.webp"}
  caption="DataDog costs for 90 RPS at 50 spans/ request 5832 mn spans with each span around 0.3 KB = 1.75 TB  @ 0.08 USD/GB-month = 140 USD/month"
...
<ZoomImage
  ...
  image={"/img/blog/2021/02/signoz-cost-90rps-1.webp"}
  caption="SigNoz cost for 90 RPS at 50 spans/request Disc cost for 15 day retention at 0.08 USD/GB-month"
...
<ZoomImage
  ...
  caption="SigNoz UI showing application metrics like latency, error rates and request rates"
