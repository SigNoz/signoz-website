...
referencePost: [open-source-datadog-alternative, community-update-14]
keywords:
...
<ZoomImage
    image={"/img/blog/2022/06/signal_13_retention_settings.webp" } alt="Retention settings on SigNoz dashboard"caption='Set retention period for your observability data depending on your use case using our retention settings'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/signal_13_trace_filter.webp" } alt="Retention settings on SigNoz dashboard"caption='Our Trace Filter page provides an array of filters to analyze tracing data'
/>
...
<ZoomImage
    image={"/img/blog/2022/05/query-builder.webp" } alt="Metrics Builder"caption='Sneak peek of Metrics Builder that our team is working on'
/>
...
<ZoomImage
    image={"/img/blog/2022/06/kubecon.webp" } alt="Metrics Builder"/>
/>
...
list={[
      {
         ...
         avatar: 'https://avatars.githubusercontent.com/u/17638736?v=4',
         link: "https://github.com/medicharlachiranjeevi"
      },
      {
         name: 'Christopher Demicoli',
         avatar: 'https://avatars.githubusercontent.com/u/8025435?v=4',
         link: "https://github.com/cdemi"
      },
      {
         name: 'Chenna Raidu D',
         avatar: 'https://avatars.githubusercontent.com/u/12108102?v=4',
         link: "https://github.com/dchennaraidu"
      },
   ]} 
/>
