...
authors: [ankit_anand]
referencePost: [open-source-datadog-alternative, community-update-05]
...
<ZoomImage
   ...
   image={"/img/blog/2021/09/metrics_graph_cpu-min.webp"}
   caption="Track and visualize critical performance metrics like CPU load with SigNoz"
...
<ZoomImage
    ...
    image={"/img/blog/2021/09/cypress_frontend_testing-min.webp"}
    caption="Testing SigNoz UI with Cypress"
...
<ZoomImage
    ...
    image={"/img/blog/2021/09/clickhouse_community_call-min.webp"}
