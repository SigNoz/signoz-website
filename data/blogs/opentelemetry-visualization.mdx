...
<ZoomImage
    image={"/img/blog/common/trace_filter_apply_aggregates.webp" } alt="Trace aggregates on SigNoz dashboard"caption='Visualize  and analyze trace aggregates with SigNoz'
/>
