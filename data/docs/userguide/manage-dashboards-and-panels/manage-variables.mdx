...
1. You want to query the list of host names from the metrics database and use them as a variable
    ...
    ![Variables-with-ClickHouse](/img/docs/var-with-clickhouse-query.png)


2. Some list of known endpoints as a variable
    ![Variables-with-Custom](/img/docs/custom-endpoint-vars.png)


3. Free text as a variable

    ![Variables-with-Text](/img/docs/text-box-limit-variable.png)
...
1. Metric Builder
    ...
    ![Variables-in-MetricsBuilder](/img/docs/query-builder-with-host_name-var.png)

2. ClickHouse Query

    ![Variables-in-ClickHouse](/img/docs/req-rate-chart-with-promql-query-and-var.png)

3. PromQL

    ![Variables-in-PromQL](/img/docs/custom-endpoint-vars.png)
