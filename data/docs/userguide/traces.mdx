...
![Open the Traces section](/img/docs/open-traces-section-v0.6.2.png)
...
![Customize the graph](/img/docs/customize-the-graph-v0.6.2.png)
...
![Advanced filtering](/img/docs/advanced-filtering-v0.6.2.png)
...
![Sort spans](/img/docs/sort-spans-v0.6.2.png)
