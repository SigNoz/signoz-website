...
import PrereqsInstrument from './shared/prereqs-instrument.mdx'
import UseHotRod from './shared/use-hotrod.mdx'
...
![Open the Services section](/images/docs/open-services-v0.10.2.png)
...
![trace-request](/images/docs/trace_request_shop.png)
...
![RED metrics](/images/docs/open-services-v0.10.2.png)
...
![resource-attribute-filtering](/images/docs/resource-attribute-filtering.png)
...
![Open the application details page](/images/docs/open-application-details-v0.10.2.png)
...
![Panes on the application details page](/images/docs/application-details-page-panes-v0.10.2.png)
...
- **Key Operations**: this list helps you find the slow operations of your application. You can select a column heading to sort the list by the values in that column. Select the column heading again to reverse the sort order or to cancel sorting.
    ![Key operations](/images/docs/key-operations-v0.10.2.png)
