...
![alert-rules](/img/docs/alert-rules.webp)
...
![alerts-query-builder](/img/docs/alerts-query-builder.webp)
...
![prometheus-alert-rules](/img/docs/promql-alerts.webp)
...
![triggered-alerts](/img/docs/triggered-alerts.webp)
...
![triggered-alerts-groups](/img/docs/triggered-alerts-groups.webp)
