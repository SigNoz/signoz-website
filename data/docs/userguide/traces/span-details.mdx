...
![Screenshot showing the span details page](/images/docs/span-details-page-v0.7.1.png)
...
![Screenshot showing a span with errors](/images/docs/identify-span-with-errors-v0.7.1.png)