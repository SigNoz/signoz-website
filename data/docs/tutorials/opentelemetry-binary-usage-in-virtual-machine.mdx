...
import HostMetrics from './shared/hostmetrics-list.mdx'
...
[open-telemetry/opentelemetry-collector-releases/releases](https://github.com/open-telemetry/opentelemetry-collector-releases/releases).
...
![traces generated by tracegen](/images/docs/tracegen-output.png)
...
![hostmetrics dashboard](/images/docs/hostmetrics-dashboard.png)
