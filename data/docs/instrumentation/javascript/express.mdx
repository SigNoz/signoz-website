...
<ZoomImage
  alt="All in one auto instrumentation library - identifies and instruments packages used by your Express application"
  image={"/images/docs/express_instrumentation.webp"}
  caption="All in one auto instrumentation library - identifies and instruments packages used by your Express application"
/>
...
<ZoomImage
  alt="Express Application in the list of services being monitored in SigNoz"
  image={"/images/docs/express_application_services_list.webp"}
  caption="Express Application in the list of services being monitored in SigNoz"
/>
