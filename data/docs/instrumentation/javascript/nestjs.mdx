...
<ZoomImage
  alt="All in one auto instrumentation library - identifies and instruments packages used by your NestJS application"
  image={"/images/docs/nestjs_instrumentation.webp"}
  caption="All in one auto instrumentation library - identifies and instruments packages used by your NestJS application"
/>
...
<ZoomImage
  alt="Nestjs Application in the list of services being monitored in SigNoz"
  image={"/images/docs/nestjs_application_instrumented.webp"}
  caption="Nestjs Application in the list of services being monitored in SigNoz"
/>
