...
<ZoomImage
  ...
  image={"/images/docs/all_in_one_auto_instrumentation.webp"}
  caption="All in one auto instrumentation library - identifies and instruments packages used by your Nodejs application"
/>
...
<ZoomImage
  ...
  image={"/images/docs/nodejs_in_services_list.webp"}
  caption="Node Application in the list of services being monitored in SigNoz"
/>
...
<ZoomImage
  alt="All in one OpenTelemetry nodejs instrumentation"
  image={"/images/docs/individual_auto_instrumentation_libraries.webp"}
  caption="You can also choose individual auto-instrumenation libraries, but the all-in-one library is recommended to get started"
/>
