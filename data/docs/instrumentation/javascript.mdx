...
<ZoomImage
  ...
  image={"/img/docs/all_in_one_auto_instrumentation.webp"}
...
<ZoomImage
  ...
  image={"/img/docs/nodejs_in_services_list.webp"}
...
<ZoomImage
  alt="All in one OpenTelemetry nodejs instrumentation"
  image={"/img/docs/individual_auto_instrumentation_libraries.webp"}
