...
<ZoomImage
  ...
  image={"/img/docs/otel_python_instrumentation.webp"}
  caption="OpenTelemetry helps generate and collect telemetry data from Python applications which can then be sent to SigNoz for storage, visualization, and analysis."
/>
...
```
Note : The port numbers are 4317 and 4318 for the gRPC and HTTP exporters respectively. Remember to allow incoming requests to port **4317**/**4318** of machine where SigNoz backend is hosted.
```
...
<ZoomImage
  alt="Python Application in the list of services being monitored in SigNoz"
  image={"/img/docs/opentelemetry_python_app_instrumented.webp"}
  caption="Python Application in the list of services being monitored in SigNoz"
/>
